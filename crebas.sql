...
VALUES ('CN006', N'Công nghệ kỹ thuật điện, điện tử');

-- 3. Công nghệ kỹ thuật cơ điện tử
INSERT INTO CHUYENNGHANH (MACN, TENCN) 
VALUES ('CN007', N'Công nghệ kỹ thuật cơ điện tử');

-- 4. Công nghệ thông tin (Chương trình dạy tiếng Anh)
INSERT INTO CHUYENNGHANH (MACN, TENCN) 
VALUES ('CN008', N'CNTT – Dạy và học bằng tiếng Anh');

-- 5. Công nghệ kỹ thuật công trình xây dựng
INSERT INTO CHUYENNGHANH (MACN, TENCN) 
VALUES ('CN009', N'Công nghệ kỹ thuật công trình xây dựng');

-- 6. Công nghệ kỹ thuật điều khiển và tự động hóa
INSERT INTO CHUYENNGHANH (MACN, TENCN) 
VALUES ('CN010', N'Công nghệ kỹ thuật điều khiển và tự động hóa');

-- 7. Thiết kế vi mạch bán dẫn (Chuyên ngành hẹp của Tự động hóa)
INSERT INTO CHUYENNGHANH (MACN, TENCN) 
VALUES ('CN011', N'Thiết kế vi mạch bán dẫn');

-- 8. Công nghệ kỹ thuật cơ khí
INSERT INTO CHUYENNGHANH (MACN, TENCN) 
VALUES ('CN012', N'Công nghệ kỹ thuật cơ khí');

-- 9. Kỹ thuật xây dựng công trình giao thông
INSERT INTO CHUYENNGHANH (MACN, TENCN) 
VALUES ('CN013', N'Kỹ thuật xây dựng công trình giao thông');

-- 10. Công nghệ kỹ thuật ô tô
INSERT INTO CHUYENNGHANH (MACN, TENCN) 
VALUES ('CN014', N'Công nghệ kỹ thuật ô tô');

-- 11. Công nghệ kỹ thuật hóa học
INSERT INTO CHUYENNGHANH (MACN, TENCN) 
VALUES ('CN015', N'Công nghệ kỹ thuật hóa học');

GO

/* Kiểm tra lại dữ liệu đã thêm */
SELECT * FROM CHUYENNGHANH;
GO